...
def Cr_Amt(accnt,name):
	...
	l_title=tk.Message(creditwn,text="PNB BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	l_title=tk.Message(debitwn,text="PNB BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def disp_tr_hist(accnt):
	...
	l_title=tk.Message(disp_wn,text="PNB BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	rootwn.title("PNB BANK-"+name)
	rootwn.configure(background='orange')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="PNB BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	...
	l_title=tk.Message(loginwn,text="PNB BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def openlink():
        webbrowser.open("https://www.maxlifeinsurance.com/investment-plans/investment-calculator?utmCode=1311262&utm_theme=MutualFund&utm_content=Mutual_Fund&utm_source=google&utm_medium=cpc&utm_campaign=Saving_Search_Core_MutualFund&gclid=Cj0KCQjwz6ShBhCMARIsAH9A0qV2ZGFWwVuPwK8-aavOOBUJYsLphnf9MgjNS2t6xzlpsUFznnFKnnQaAvcEEALw_wcB")

def openlink1():
        webbrowser.open("https://www.muthootfinance.com/gold-loan/eligibility")

def openlink2():
        webbrowser.open("https://praveenmp.github.io/stockaveragecalculator/")
...
def Create():
	...
	l_title=tk.Message(crwn,text="PNB BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	rootwn=tk.Tk()
	rootwn.geometry("1600x500")
	rootwn.title("PNB Bank")
	rootwn.configure(background='orange')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	bg_image = tk.PhotoImage(file ="realtime-banking-FB.png")
	x = tk.Label (image = bg_image)
	x.place(y=-400)
	l_title=tk.Message(text="PNB BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	imgc1=tk.PhotoImage(file="new.gif")
	imglo=tk.PhotoImage(file="login.gif")
	imgc5=tk.PhotoImage(file="ritik.png")
	imgc7=tk.PhotoImage(file="r.png")
	imgc40=tk.PhotoImage(file="Stock_Average_Calculator.png")
	imgc56=tk.PhotoImage(file="chatbot.png")
	imgc=imgc1.subsample(2,2)
	imglog=imglo.subsample(2,2)
	imgc51=imgc5.subsample(2,2)
	imgc34=imgc7.subsample(2,2)
	imgc01=imgc40.subsample(2,2)
	imgc10=imgc56.subsample(2,2,)
	...
	b8=tk.Button(image=imgc51,command=openlink)
	b8.image=imgc51
	b8.place(x=800,y=500)
	b9=tk.Button(image=imgc34,command=openlink1)
	b9.image=imgc34
	b9.place(x=500,y=500)
	b10=tk.Button(image=imgc01,command=openlink2)
	b10.place(x=100,y=500)
	b11=tk.Button(image=imgc10,command=chatbot)
	b11.place(x=1100,y=500)
